...
@Component({
  ...
  styles: [`
    ...
    .input-area { background: rgba(255,255,255,0.9); backdrop-filter: blur(10px); padding-bottom: calc(env(safe-area-inset-bottom) + 108px); border-top: 1px solid rgba(0,0,0,0.05); display: flex; flex-direction: column; }
