...
@Component({
  ...
  `,
  styles: [`
    .games-hub-container { padding: calc(var(--safe-top) + 40px) 20px 20px; padding-bottom: 80px; background: #fff0f3; min-height: 100vh; height: 100vh; overflow-y: auto; overflow-x: hidden; position: relative; }
