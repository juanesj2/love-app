...
@Component({
  ...
  styles: [`
    ...
    .swipe-container { padding: 20px; background: #fff0f3; min-height: 100%; display: flex; flex-direction: column; padding-bottom: 50px; }
    ...
    .no-data { color: #888; font-style: italic; text-align: center; }
  `],
  standalone: true,
